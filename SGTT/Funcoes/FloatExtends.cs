...
namespace SGAP.Funcoes
{
    ...
    {
        public static string toExtenso(this float valor)
        {
            ...
            else
            {
                ...
                {
                    valor_por_extenso += escreva_parte(Convert.ToSingle(strValor.Substring(i, 3)));
        ...
        static string escreva_parte(float valor)
        {
            if (valor <= 0)
                return string.Empty;
            else
